...
export function DashboardSidebar() {
  ...
  return (
    <aside className="fixed ltr:left-0 rtl:right-0 top-0 z-40 h-screen w-64 ltr:border-r rtl:border-l bg-white dark:bg-slate-950 transition-transform hidden sm:block">
      <div className="flex h-full flex-col px-3 py-4">
        ...
        <div className="mt-auto border-t pt-4">
          ...
          <form action={async () => { await logout() }}>
            <Button variant="ghost" className="w-full justify-start text-red-600 hover:text-red-700 hover:bg-red-50 dark:hover:bg-red-950/50" type="submit">
